...
function TcpClient(tcpHost, tcpPort, serialPort, serialBaudRate, log) {
    ...
    function processQueue() {
        ...
        logMsg('CLIENT: Sp write data', current.id, current.code, spProtocol.serialize(current.code, current.data));
    ...
    sp.on('data', function (data) {
        ...
        while (result.valid) {
            logMsg('CLIENT: Sp package unserialized', current.id, result.code, result.data);
    ...
    tp.on('data', function (data) {
        ...
        while (result.valid) {
            logMsg('CLIENT: Tcp package unserialized', result.id, result.code, result.data);
